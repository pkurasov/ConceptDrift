...
public class ClassOption extends AbstractClassOption {
    ...
    public static Object cliStringToObject(String cliString,
        ...
        Class<?> classObject;
        try {
            classObject = Class.forName(className); // Returns the Class object 
        } catch (Throwable t1) {
            try {
        ...
        try {
            ...
            //System.out.println("requiredType: " + " " + requiredType.getClass().getCanonicalName());
            //System.out.println("classInstance: " + " " + classInstance.getClass().getCanonicalName());
            //System.out.println("Is classInstance an instance of requiredType?: " +" " + requiredType.isInstance(classInstance));
            //System.out.println("classInstance instanceof Task?: " + (classInstance instanceof Task));
            //System.out.println("requiredType.isAssignableFrom(((Task) classInstance).getTaskResultType()))?:  "+requiredType.isAssignableFrom(((Task) classInstance).getTaskResultType()));
        } catch (Exception ex) {
